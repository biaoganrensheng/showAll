        ...
        function rdochecked(tag) {
            $('.' + tag).each(function (i) {
                ...
                if ($('.' + tag).eq(i).prop("checked") == false) {
                    ...
                    rdobox.find(".check-image").css("background", "url(radioCheckbox/images/input-unchecked.png) no-repeat");
                }
                else {
                    rdobox.removeClass("unchecked");
                    rdobox.addClass("checked");
                    rdobox.find(".check-image").css("background", "url(radioCheckbox/images/input-checked.png) no-repeat");
                }
            });
        }
    }
