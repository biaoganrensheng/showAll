define('script/common/mapControl', function(require, exports, module) {
  ...
  window.mapControl = {
      ...
      initMap: function initMap() {
          ...
          canvasScript.src = '/webApp/static/javascript/CanvasLayer.js';
      ...
      */
      ...
      setMonitorInfoBox: function setMonitorInfoBox(data) {
          ...
          var infoContentNextArr = ['</div>', '<div class="infoControl">', '<div class="infoZoomIn" id="monitorInfoZoomIn">', '放大', '</div>', '</div>', '</div>'];
          this.monitorInfoBox = new BMapLib.InfoBox(map, infoContentFrontArr.concat(infoContentNextArr).join(''), {
              ...
              alignBottom: false,
              closeIconUrl: '/webApp/static/images/closeinfowindow.png'
          });
      ...
      setEntityMarker: function setEntityMarker(data, service_type) {
          ...
          if (service_type === 1) {
              ...
              switch (status.substring(0, 2)) {
                  case '离线':
                      iconUrl = '/webApp/static/images/caroffnorth.png';
                      break;
                  case '静止':
                      iconUrl = '/webApp/static/images/carstaticnorth.png';
                      break;
                  default:
                      iconUrl = '/webApp/static/images/carrunnorth.png';
                      break;
              }
          } else {
              ...
              switch (status.substring(0, 2)) {
                  case '离线':
                      iconUrl = '/webApp/static/images/othertypeoffline.png';
                      break;
                  case '静止':
                      iconUrl = '/webApp/static/images/othertypestatic.png';
                      break;
                  default:
                      iconUrl = '/webApp/static/images/othertype.png';
                      break;
              }
          }
  ...
  //# sourceMappingURL=/webApp/script/common/mapControl.js.map
