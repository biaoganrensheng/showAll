define('script/modules/entitycontrol/stores/entityStore', function(require, exports, module) {
      ...
      setEntities: function setEntities(data) {
          ...
          data.entities.map(function (item) {
              ...
              _commonUrls2['default'].jsonp(_commonUrls2['default'].getAddress, paramsGeo, function (dataGeo) {
                  ...
                  that.data.entities.push([['entity_name', item.entity_name], ['entity_desc', item.entity_desc ? item.entity_desc : '无'], ['create_time', item.create_time], ['local_address', dataGeo.result.formatted_address === '' ? '无' : dataGeo.result.formatted_address], ['loc_time', _commonCommonfun2['default'].getLocalTime(item.latest_location.loc_time)]].concat(temp));
  ...
  //# sourceMappingURL=/webApp/script/modules/entitycontrol/stores/entityStore.js.map
