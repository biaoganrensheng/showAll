define('script/modules/trackcontrol/views/trackanalysis', function(require, exports, module) {
  ...
  var TrackAnalysis = _react2['default'].createClass({
       ...
       */
      drawAnalysisBehavior: function drawAnalysisBehavior(data) {
          if (!data) {
          ...
          for (var i = 0; i < data.harsh_acceleration.length; i++) {
              ...
              var value = '急加速';
              var loc_time = data.harsh_acceleration[i].loc_time;
          ...
          for (var i = 0; i < data.harsh_breaking.length; i++) {
              ...
              var value = '急减速';
              var loc_time = data.harsh_breaking[i].loc_time;
              if (starttime <= loc_time && loc_time <= endtime) {
          ...
          for (var i = 0; i < data.harsh_steering.length; i++) {
              ...
              var value = '急转弯';
              var loc_time = data.harsh_steering[i].loc_time;
              if (starttime <= loc_time && loc_time <= endtime) {
          ...
          for (var i = 0; i < data.speeding.length; i++) {
              ...
              var loc_time = data.speeding[i].speeding_points[0].loc_time;
              if (starttime <= loc_time && loc_time <= endtime) {
       ...
       * @param {number} endtime 时间区间终点 可选
       */
      drawStaypoint: function drawStaypoint(data) {
          if (!data) {
              data = this.state.currentAnalysisData;
          }
          var starttime = this.state.starttime;
          ...
          return _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                          'div',
                          { className: 'trafficMethodItem' },
                          _react2['default'].createElement('input', { type: 'radio', name: 'trafficMethod', id: 'byCar' }),
                          _react2['default'].createElement(
                              'label',
                              { htmlFor: 'byCar' },
                              '驾车'
                      ...
                      _react2['default'].createElement(
                          'div',
                          { className: 'trafficMethodItem' },
                          _react2['default'].createElement('input', { type: 'radio', name: 'trafficMethod', id: 'byBike' }),
                          _react2['default'].createElement(
                              'label',
                              { htmlFor: 'byBike' },
                              '骑行'
                      ...
                      _react2['default'].createElement(
                          'div',
                          { className: 'trafficMethodItem' },
                          _react2['default'].createElement('input', { type: 'radio', name: 'trafficMethod', id: 'byWalk' }),
                          _react2['default'].createElement(
                              'label',
                              { htmlFor: 'byWalk' },
                              '步行'
  ...
  //# sourceMappingURL=/webApp/script/modules/trackcontrol/views/trackanalysis.js.map
