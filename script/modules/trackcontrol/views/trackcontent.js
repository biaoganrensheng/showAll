define('script/modules/trackcontrol/views/trackcontent', function(require, exports, module) {
          ...
          var update = function update() {
                          ...
                          (function () {
                              ...
                              if (totalPoints[i + 1].loc_time >= starttime && totalPoints[i + 1].loc_time <= endtime) {
                                  (function () {
                                      ...
                                      partImgStart.src = '/webApp/static/images/startpoint.png';
                                      var next = nextPixel;
                              ...
                              if (totalPoints[i].loc_time >= starttime && totalPoints[i].loc_time <= endtime) {
                                  (function () {
                                      ...
                                      partImgEnd.src = '/webApp/static/images/endpoint.png';
              ...
              if (totalPoints[0].loc_time >= starttime) {
                  (function () {
                      ...
                      imgStart.src = '/webApp/static/images/startpoint.png';
              ...
              if (totalPoints[totalPoints.length - 1].loc_time <= endtime) {
                  (function () {
                      ...
                      imgEnd.src = '/webApp/static/images/endpoint.png';
  ...
  //# sourceMappingURL=/webApp/script/modules/trackcontrol/views/trackcontent.js.map
